    ...
    <section className='max-padd-container flex flex-col gap-8 xl:flex-row bg-primary py-4'>
        ...
        <div className='flex flex-col xl:flex-[1.5] bg-white px-6 py-2 rounded-xl '>
            ...
            <div>
                ...
                rounded-full bg-secondaryRed'></div>
                <div className='ring-2 ring-slate-900 h-10 w-10 flexCenter cursor-pointer 
                rounded-full bg-secondaryYellow'></div>
                <div className='ring-2 ring-slate-900 h-10 w-10 flexCenter cursor-pointer 
                rounded-full bg-secondaryBlue'></div>
                <div className='ring-2 ring-slate-900 h-10 w-10 flexCenter cursor-pointer 
                rounded-full bg-secondaryGreen'></div>
                </div>
            </div>
            {/*  */}
            <div>
            ...
            <p><span className='medium-16 text-tertiary'>Category:</span>Woman | Jacket | Winter</p>
            <p><span className='medium-16 text-tertiary'>Tags:</span>Modern | New Arrivels </p>
